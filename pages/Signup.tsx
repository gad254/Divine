  ...
  return (
    <div className="h-full bg-white flex flex-col px-6 md:px-8 py-6 md:pt-8 md:pb-8 relative overflow-y-auto">
      ...
      <div className="grid grid-cols-4 gap-3 md:gap-4 shrink-0">
          <button type="button" onClick={() => handleOAuthLogin('google')} className="aspect-square bg-white border border-gray-200 rounded-2xl flex items-center justify-center hover:bg-gray-50 hover:scale-105 transition-all shadow-sm">
          ...
          <button type="button" onClick={() => handleOAuthLogin('facebook')} className="aspect-square bg-[#1877F2] rounded-2xl flex items-center justify-center hover:opacity-90 hover:scale-105 transition-all shadow-sm text-white">
          ...
          <button type="button" onClick={() => handleOAuthLogin('instagram')} className="aspect-square bg-gradient-to-tr from-[#FD1D1D] via-[#E1306C] to-[#C13584] rounded-2xl flex items-center justify-center hover:opacity-90 hover:scale-105 transition-all shadow-sm text-white">
          ...
          <button type="button" onClick={() => handleOAuthLogin('tiktok')} className="aspect-square bg-black rounded-2xl flex items-center justify-center hover:opacity-80 hover:scale-105 transition-all shadow-sm text-white">
